...
<html>
    ...
    <!-- /Sidebar Menu -->
                                        ...
                                        <div id="horizontal-form">
                                            <div class="form-horizontal" method="post" role="form">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input class="form-control" id="level_name" name="level_name" value="<?php echo ($brandRes["level_name"]); ?>" placeholder="等级名称" type="text">
                                                        </input>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input class="form-control" id="points_min" name="points_min" placeholder="等级下限" value="<?php echo ($brandRes["points_min"]); ?>" required="" type="text">
                                                        </input>
                                                    </div>
                                                    <p class="help-block col-sm-4 red">
                                                        * 必填
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input class="form-control" id="points_max" name="points_max" value='<?php echo ($brandRes["points_max"]); ?>' placeholder="等级上限"  type="text">
                                                        </input>
                                                    </div>
                                                    <p class="help-block col-sm-4 red">
                                                        * 必填
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input class="form-control" id="rate" name="rate" value='<?php echo ($brandRes["rate"]); ?>' placeholder="品牌折扣率"  type="text">
                                                        </input>
                                                    </div>
                                                    <p class="help-block col-sm-4 red">
                                                        * 必填
        ...
        <script src="Public/Admin/js/memner/add.js"></script>
