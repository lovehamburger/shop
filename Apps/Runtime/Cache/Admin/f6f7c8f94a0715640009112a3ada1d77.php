...
<html><head>
    ...
    <script src="/Public/ueditor/lang/zh-cn/zh-cn.js
"></script>
</head>
<body>
    <!-- 头部 -->
...
<div class="row">
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <?php else: ?>
                                            <img src="<?php echo ($goods["sm_thumb"]); ?>" height="24"><?php endif; ?>
                                        </div>
                                    </div>
                                    <div class="form-group">
    ...
    function attrad(o){
        ...
        if($(o).html() == '[+]'){
            ...
            if(confirm('确定要删除该商品属性吗？')){
                ...
                $.ajax({
                type:"GET",
                url:"/Admin-Goods/ajaxdelga/gaid/"+gaid,
    ...
    function delpic(o){
        if(confirm('确定要删除该图片吗？')){
            ...
            $.ajax({
                type:"GET",
                url:"/Admin-Goods/ajaxdelpic/picid/"+picid,
                success:function(data){
                    li.remove();
                }
            });
    ...
    $("select[name=type_id]").change(function(){
        ...
        $.ajax({
            type:"GET",
            url:"/Admin-Goods/ajaxgetattr/typeid/"+typeid,
            dataType:"json",
            // success : function(data){
