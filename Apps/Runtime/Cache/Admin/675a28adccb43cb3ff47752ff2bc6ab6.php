    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">新增类型</span>
            </div>
            <div class="widget-body">
                <div id="horizontal-form">
                    <div class="form-horizontal" role="form" >
                        <input type='hidden' class="attrId" value='<?php echo ($attrRes["id"]); ?>'>
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">属性名称</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="attr_name" placeholder="" name="attr_name"  type="text" value = '<?php echo ($attrRes["attr_name"]); ?>'>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6 radio">
                                <label>
                                    <input type="radio" <?php if($attrRes["attr_type"] == 0): ?>checked="checked"<?php endif; ?>  value="0" name="attr_type">
                                    <span class="text">唯一</span>
                                </label>
                                <label>
                                    <input type="radio" <?php if($attrRes["attr_type"] == 1): ?>checked="checked"<?php endif; ?> class="inverted" value="1" name="attr_type">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <textarea name='attr_values' style="width: 80%;height: 100px"><?php echo ($attrRes["attr_values"]); ?></textarea>
                            </div>
                            <p class="col-sm-4 red" style="line-height: 135px">多个值请用,号隔开</p>
                        </div>
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">商品类型</label>
                            <div class="col-sm-6">
                               <select  style=" padding-top:3px">
                                    <?php if(is_array($goodType)): $i = 0; $__LIST__ = $goodType;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option name='typeId' <?php if($vo["id"] == $attrRes['type_id']): ?>selected='selected'<?php endif; ?> value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["type_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                                <button type="submit" class="btn btn-default attrAdd">保存信息</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <script src="Public/Admin/js/goodsType/addAttr.js"></script>
