...
<div class="row">
    <div class="col-lg-12 col-sm-12 col-xs-12">
            ...
            <div class="widget-body">
                ...
                <div class="flip-scroll">
                    <table class="table table-bordered table-hover">
                        <thead class="">
                            <tr>
                                <?php if(is_array($res)): $i = 0; $__LIST__ = $res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><th class="text-center" width="26%"><?php echo ($key); ?></th><?php endforeach; endif; else: echo "" ;endif; ?>
                                <th class="text-center" width="26%">库存</th>
                                <th class="text-center" width="26%">操作</th>
                            </tr>
                        </thead>
                        <tbody class="product-list">
                            <?php if($productRes != '' ): if(is_array($productRes)): foreach($productRes as $k=>$value): ?><tr class="products">
                                    <?php if(is_array($res)): $i = 0; $__LIST__ = $res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><td>
                                            <select name="attr_name">
                                                <?php if(is_array($res[$key])): $i = 0; $__LIST__ = $res[$key];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value=<?php echo ($v["id"]); ?> <?php if(in_array($v['id'],$value['goods_attr_arr'])): ?>selected<?php endif; ?> ><?php echo ($v["attr_value"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                            </select>
                                        </td><?php endforeach; endif; else: echo "" ;endif; ?>
                                <td align="center"><input type="text" name="goods_number" value='<?php echo ($value["goods_number"]); ?>' placeholder="" class="form-control"></td>
                                <td align="center">

                                <input type="button" class="btn btn-primary btn-sm shiny product" <?php if($k == 0): ?>value="+"<?php else: ?>value="-"<?php endif; ?>>
                                </td>
                    ...
                    <button value="" style="width:150px; margin-top:10px;" class="btn btn-darkorange btn-block addProduct" type="submit">保存信息</button>
                </div>
                <div>
                </div>
            </div>
        ...
        <script src="Public/Admin/js/goods/product.js"></script>
