...
<html>
    ...
    <!-- /Sidebar Menu -->
                    ...
                    <div class="page-body">
                        <div class="row">
                            <div class="col-lg-12 col-sm-12 col-xs-12">
                                <div class="widget">
                                <input type="hidden" id=adminId value="<?php echo ($adminRes["id"]); ?>">
                                        ...
                                        <div id="horizontal-form">
                                            <div class="form-horizontal" method="post" role="form">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input class="form-control" id="username" name="username" placeholder="" value="<?php echo ($adminRes["username"]); ?>" required="" type="text">
                                                        </input>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="col-sm-offset-2 col-sm-10">
                                                        <button class="btn btn-default sub_btn">
                                                            保存信息
                                                        </button>
                                                    </div>
                                                </div>
        ...
        <script src="Public/Admin/js/admin/admin.js"></script>
