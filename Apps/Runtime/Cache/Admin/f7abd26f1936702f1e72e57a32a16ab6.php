...
<div class="main-container container-fluid">
    ...
    <!-- /Sidebar Menu -->
		...
		<div class="page-content">
			...
			<!-- Page Body -->
			<div class="page-body">
				<button class="btn btn-sm btn-azure btn-addon" onclick="javascript:window.location.href = '<?php echo U('admin-publish');?>'" tooltip="添加用户" type="button">
					<i class="fa fa-plus">
					</i>
					Add
				</button>
...
<script src="Public/Admin/js/admin/list.js"></script>
