...
<button type="button" tooltip="添加用户" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '/Admin-Goods-addAttr-typeId-<?php echo I('get.typeId');?>'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
    <div class="col-lg-12 col-sm-12 col-xs-12">
        ...
        <script src="Public/Admin/js/goodsType/attr.js"></script>
