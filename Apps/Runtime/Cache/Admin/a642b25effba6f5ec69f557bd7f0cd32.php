...
<div class="main-container container-fluid">
    ...
    <!-- /Sidebar Menu -->
		...
		<div class="page-content">
			...
			<!-- Page Body -->
			<div class="page-body">
				<button class="btn btn-sm btn-azure btn-addon" onclick="javascript:window.location.href = '<?php echo U('Member-publishLevel');?>'" tooltip="添加用户" type="button">
					<i class="fa fa-plus">
					</i>
					Add
				</button>
									...
									<table class="table table-bordered table-hover">
										...
										<tbody>
											<?php if(is_array($res)): $i = 0; $__LIST__ = $res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
												...
												<td align="left"><?php echo ($vo["level_name"]); ?></td>
												<td align="left"><?php echo ($vo["points_min"]); ?></td>
												<td align="left"><?php echo ($vo["points_max"]); ?></td>
												<td align="left"><?php echo ($vo["rate"]); ?></td>
												<td align="center" style="width: 30%">
													<a href="/Admin-Member-publishLevel-levelId-<?php echo ($vo["id"]); ?>" class="btn btn-primary btn-sm shiny">
														<i class="fa fa-edit"></i> 编辑
													</a>
													<a href="#" value="11" class="btn btn-danger btn-sm del">
...
<script src="Public/Admin/js/member/level.js"></script>
